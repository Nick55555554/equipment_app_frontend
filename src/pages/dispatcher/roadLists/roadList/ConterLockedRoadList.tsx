...
const ConterLockedRoadList = ({number}: {number: string}) => {
        ...
        <Header  onDataChange={setTechnic}/>
            ...
            <div className="infoRoadList">
                ...
                <div 
                    ...
                    <div
                className="smallAnalytishForRoadList">
                        <div className="heighWeightLIST">Название:<span className="lowWeight">{}</span></div>
                        <div className="heighWeightLIST">ИНН:<span className="lowWeight">{}</span></div>
                        <div className="heighWeightLIST">КПП:<span className="lowWeight">{}</span></div>
                        <div className="heighWeightLIST">Юр. Адрес:<span className="lowWeight">{}</span></div>
                    </div>
                    <div 
                    className="bigAnalytishForRoadList">
...
export default ConterLockedRoadList;

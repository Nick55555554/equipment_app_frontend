...
export const SmallTableLODis = () => {
            ...
            {technics.map((technic) => (
                technic.equipmentTypeResponses.length > 0 ? (
                    technic.equipmentTypeResponses.map((one) => (
                        ...
                        <td className="left_td_small" onClick={(e) => {
                            e.stopPropagation(); 
                        }}>
                            {technic.name}
                        </td>
                        <td className="left_td_small">
                            {one.type}
                        </td>
    ...
    return(
        <div className="smallTableDis">
            <table className="table_smallDis">
                <thead>
                    <tr>
                        <th className="left_thSmall">Номер</th>
                        <th className="left_thSmall">Марка</th>
                        <th className="left_thSmall last_th">Состояние машины</th>
                    </tr>
                </thead>
